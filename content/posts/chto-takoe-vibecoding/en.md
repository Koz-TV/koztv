...
Over a weekend – SaaS with auth, tool with a database. That's how I build [chess.rodeo](https://chess.rodeo).

## Where to start

Pick a tool:
- [Lovable](https://lovable.dev) or [Replit](https://replit.com) – everything in browser, nothing to install
- [Codex](https://openai.com/codex) – harder to figure out, but more flexible
- [Claude Code](https://claude.ai/download) – popular, but decent work needs a $100+/month plan

More on tools [in a separate post](/posts/about-tools-models-for-vibe-coding/).
...
Want to learn? I [do mentoring](/work-with-me/). In a few calls I'll show you how to build products yourself.
